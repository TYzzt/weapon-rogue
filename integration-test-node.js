...
try {
    require('./enhanced-save-system.js');
    console.log("✅ 增强版存档系统加载成功");
} catch (e) {
    console.log(`❌ 增强版存档系统加载失败: ${e.message}`);
}
...
function runNodeIntegrationTest() {
    console.log("\n🔍 验证游戏引擎初始化...\n");
...
// 运行测试
const testResult = runNodeIntegrationTest();

// 导出测试结果
module.exports = { runNodeIntegrationTest, testResult };
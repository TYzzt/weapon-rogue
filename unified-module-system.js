...
// 创建全局统一游戏系统实例
window.GameSystem = new UnifiedGameSystem();
window.gameState = window.GameSystem.getState();

console.log("🔄 统一模块系统已准备就绪");
